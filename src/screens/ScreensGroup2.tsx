...
const QUICK_FOODS: FoodItem[] = [
  { name: 'Grilled Chicken Breast', calories: 165, protein: 31, carbs: 0, fat: 3.6, fiber: 0, serving: '100g' },
  { name: 'White Rice (cooked)', calories: 130, protein: 2.7, carbs: 28, fat: 0.3, fiber: 0.4, serving: '100g' },
  { name: 'Scrambled Eggs (2)', calories: 180, protein: 12, carbs: 2, fat: 14, fiber: 0, serving: '2 eggs' },
  { name: 'Salmon Fillet', calories: 208, protein: 20, carbs: 0, fat: 13, fiber: 0, serving: '100g' },
  { name: 'Greek Yogurt 0%', calories: 59, protein: 10, carbs: 3.6, fat: 0.4, fiber: 0, serving: '100g' },
  { name: 'Banana', calories: 89, protein: 1.1, carbs: 23, fat: 0.3, fiber: 2.6, serving: '1 medium' },
  { name: 'Oats', calories: 389, protein: 16.9, carbs: 66, fat: 6.9, fiber: 10.6, serving: '100g' },
  ...
  { name: 'Whey Protein (1 scoop)', calories: 120, protein: 24, carbs: 3, fat: 1, fiber: 0, serving: '30g' },
  { name: 'Avocado', calories: 160, protein: 2, carbs: 9, fat: 15, fiber: 7, serving: '100g' },
  { name: 'Air Fryer Potatoes', calories: 120, protein: 2.5, carbs: 22, fat: 2.5, fiber: 2, serving: '100g' },
];
        ...
        <div className="px-4 pt-2 pb-6">
          ...
          <div className="flex gap-2 overflow-x-auto scrollbar-hide mb-4">
            {['All', 'Protein', 'Carbs', 'Vegetables', 'Fruits', 'Dairy'].map(cat => (
              <button key={cat} className="chip whitespace-nowrap">{cat}</button>
            ))}
          </div>
